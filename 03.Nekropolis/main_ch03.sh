...
function tavern() {
	...
	case ${VAR} in
		...
		"ls")				echo "-rw-r--r--  1 ${PLAYER} ${PLAYER}    675 ${DATE} the_keeper"
							tavern;;

		"finger the_keeper")  count=0
							total=30
							echo "Enquiring information from the keeper."
							pstr="[...............................................................]"
...
function the_end() {
	...
	printf "${GREEN}NOT THE END${END_COLOR} ${RED}>${END_COLOR} "
	read VAR
